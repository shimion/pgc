...
function x_shortcode_feature_box( $atts, $content = '' ) {
  ...
  if ( $graphic == 'image' ) {
    ...
    $graphic = '<div' . $graphic_container_class_style . '>'
               . '<div' . $graphic_outer_class_style . '>'
                 . '<div' . $graphic_inner_class_style . '><a href="' . $href . '" title="' . $href_title . '"' . $href_target . $link_color . '>'
  ...
  $output = '<div class="x-feature-box-content"' . $side_align_style . '>'
             . '<h4 class="x-feature-box-title"' . $title_color . '><a href="' . $href . '" title="' . $href_title . '"' . $href_target . $link_color . '>' . $title . '</a></h4>'
