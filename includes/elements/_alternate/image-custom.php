...
class CS_Image_custom extends Cornerstone_Element_Base {

  public function data() {
    return array(
      'name'        => 'image_custom',
      'title'       => __( 'Image Custom', csl18n() ),
      'section'     => 'media',
  ...
  public function render( $atts ) {
    ...
    $shortcode = "[x_image_custom type=\"$image_style\" src=\"$src\" alt=\"$alt\" link=\"$link\" href=\"$href\" title=\"$href_title\" target=\"$href_target\" info=\"$info\" info_place=\"$info_place\" info_trigger=\"$info_trigger\" info_content=\"$info_content\"{$extra}]";
