...
class CS_Prompt_custom extends Cornerstone_Element_Base {

  public function data() {
    return array(
      'name'        => 'prompt_custom',
      'title'       => __( 'Prompt Custom', csl18n() ),
      'section'     => 'marketing',
  ...
  public function render( $atts ) {
    ...
    $shortcode = "[x_prompt_custom type=\"$align\" title=\"$heading\" leadbox=\"$leadbox\" message=\"$message\" button_text=\"$button_text\" button_icon=\"$button_icon\" circle=\"$circle\" href=\"$href\" href_title=\"$href_title\" target=\"$href_target\"{$extra}]";
